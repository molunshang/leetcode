...
namespace leetcode
{
    ...
    class Program
    {
        ...
        {
            program.FindLadders("red", "tax", new[] { "ted", "tex", "red", "tax", "tad", "den", "rex", "pee" });
        ...
        void RestoreIpAddresses(string s, int index, IList<string> result, List<string> sub)
        {
            ...
            for (int i = 1; i <= 3; i++)
            {
                ...
                RestoreIpAddresses(s, index + i, result, sub);
        ...
        {
            var result = new List<string>();
            RestoreIpAddresses(s, 0, result, new List<string>());
            return result;
        }
        ...
        void LetterCombinations(Dictionary<char, char[]> dic, string digits, int dIndex, List<char> subs,
            List<string> result)
        {
        ...
        void Subsets(int index, int[] nums, IList<IList<int>> result, IList<int> sub)
        {
            if (index >= nums.Length)
            {
                result.Add(sub.ToArray());
                return;
            }
        ...
        {
            var result = new List<IList<int>>();
            Subsets(0, nums, result, new List<int>());
            return result;
        }
        ...
        void WordBreak(string s, int index, int min, int max, HashSet<string> wordDict, IList<string> result, IList<string> stb)
        {
            if (index >= s.Length)
            {
        ...
        IList<string> WordBreak1(string s, int index, int min, int max, HashSet<string> wordDict, Dictionary<int, IList<string>> nexts)
        {
